...
public class BasicRowProcessor implements RowProcessor {
	 ...
	 *
	 * @see com.cplatform.dbhelp.dbutils.RowProcessor#toArray(java.sql.ResultSet)
	 * @param rs
	 ...
	 * 
	 * @see com.cplatform.dbhelp.dbutils.RowProcessor#toBean(java.sql.ResultSet, Class)
	 * @see com.cplatform.dbhelp.dbutils.BeanProcessor#toBean(java.sql.ResultSet, Class)
	 * @param <T>
	...
	/**
	 * Convert a <code>ResultSet</code> into a <code>List</code> of JavaBeans. This implementation delegates to a BeanProcessor instance.
	 * 
	 * @see com.cplatform.dbhelp.dbutils.RowProcessor#toBeanList(java.sql.ResultSet, Class)
	 * @see com.cplatform.dbhelp.dbutils.BeanProcessor#toBeanList(java.sql.ResultSet, Class)
	 * @param <T>
	 *            The type of bean to create
	 * @param rs
	 *            ResultSet that supplies the bean data
	 ...
	 * 
	 * @see com.cplatform.dbhelp.dbutils.RowProcessor#toMap(java.sql.ResultSet)
	 * @param rs
