...
/**
 * <code>ResultSetHandler</code> implementation that converts one <code>ResultSet</code> column into a <code>List</code> of <code>Object</code>s. This class is thread safe.
 *
 * @param <T>
...
public class ColumnListHandler<T> extends AbstractListHandler<T> {
	...
	/**
	 * Creates a new instance of ColumnListHandler. The first column of each row will be returned from <code>handle()</code>.
	 */
