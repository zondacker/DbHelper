...
import com.opensource.dbhelp.dbutils.BasicStringRowProcessor;
import com.opensource.dbhelp.dbutils.ResultSetHandler;
import com.opensource.dbhelp.dbutils.StringRowProcessor;

/**
 * <code>ResultSetHandler</code> implementation that converts a <code>ResultSet</code> into an <code>String[]</code>. This class is thread safe.
 * 
...
public class StringArrayHandler implements ResultSetHandler<String[]> {
	...
	/**
	 * The StringRowProcessor implementation to use when converting rows into arrays.
	 */
	 ...
	 * 
	 * @param convert
	 *            The <code>StringRowProcessor</code> implementation to use when converting rows into arrays.
	 */
